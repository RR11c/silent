...
game.StarterGui:SetCore(
    ...
    {
	Title = "RS",
	Text = "hola its silent aim aim aim ",
}
)
local L_3_ = loadstring(game:HttpGet("https://raw.githubusercontent.com/xHeptc/Kavo-UI-Library/main/source.lua"))()
local L_4_ = L_3_.CreateLib("ReplicatedStorage", "DarkTheme")
local L_5_ = L_4_:NewTab("Silent")
local L_6_ = L_5_:NewSection("ReplicatedStorag")
L_6_:NewButton(
    "NIGGER",
    "Beam niggas down",
    function()
...
local L_8_ = L_7_:NewSection("ReplicatedStorage")
L_8_:NewButton(
    "Silent Aim",
...
local L_12_ = L_11_:NewSection("ReplicatedStorage")
L_12_:NewButton(
    "Anti-Lock",
    "Key is Z.",
    function()
...
local L_14_ = L_13_:NewSection("ReplicatedStorage")
L_14_:NewKeybind(
    "Keybind Gui Toggle",
    "h",
    Enum.KeyCode.V,
...
local L_19_ = L_17_:NewSection("ReplicatedStorage")
L_19_:NewToggle(
    "ESP",
    "ESP",
    function(L_201_arg0)
...
game.Players.LocalPlayer:Kick("PERM-BANNED")
